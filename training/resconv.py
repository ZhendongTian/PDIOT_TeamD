...
from tensorflow.keras.layers import Activation, Dropout, Flatten, Dense, Conv1D, BatchNormalization, Input, Layer
...
def ResNet50(input_shape = (30000, 1), n_out=1):
    ...
    X = Conv1D(64, 7, strides = 2, name = 'conv1', kernel_initializer = glorot_uniform(seed=0))(X_input)
